...
基于 Tauri v2、React 和 Rust 构建的桌面视频下载与浏览工具，支持 JableTV、MissAV 和 SupJav。
...
- **卡片悬停预览**：悬停卡片时加载视频预览片段并生成内存 Blob URL 播放。
- **批量任务控制**：下载队列提供双行紧凑布局与 Hover 工具提示，支持全选、多选以及批量开始、暂停和取消操作。
